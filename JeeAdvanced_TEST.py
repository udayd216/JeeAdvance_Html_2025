...
# Step 2: Define URLs
login_url = "https://cportal.jeeadv.ac.in/authenticate"
result_url = "https://cportal.jeeadv.ac.in/candidate-view"
...
str_Jeeappno = "SELECT SNO, REGNO, DOB, MOBILENO, MOBILE1, MOBILE2, ADMNO FROM I_JEEADV_ADMITCARD_25 WHERE PROCESS_STATUS_URL = 'P' \
